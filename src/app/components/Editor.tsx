...
export default function Editor({ data, setData, defaultData }: Props) {
  ...
  const editorConfig: any = {
    ...
    simpleUpload: {
      uploadUrl: `${process.env.NEXT_PUBLIC_URL_CLIENT}/api/upload/blog`,
      headers: {
        folder_type: 'blog'
      },
  ...
  return (
    <div className='main-container w-[550px]'>
      <div
